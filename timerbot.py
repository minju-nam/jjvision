...
def start(update, context):
    update.message.reply_text('Hello! Stranger! Long Time No See! /set <seconds> to set a timer')
...
def main():
    ...
    updater = Updater("1367543231:AAF0qV6-lJjW75V_Rw1lKELDkIyOxctlAB8", use_context=True)
